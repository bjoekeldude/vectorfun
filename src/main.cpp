...
void mainLoop(std::vector<int>& internal_container){
    for(;;){                                        /////an dieser Stelle auch while(1) oder while(true)
        ...
        switch(option){
            ...
            case 1:     add_value(internal_container);                  break;
            case 2:     print_first(internal_container);                break;
            case 3:     print_last(internal_container);                 break;
            case 4:     print_all(internal_container);                  break;
